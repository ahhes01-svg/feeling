...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      this._empty.addEventListener('click', () => { if (!this.hasAttribute('locked')) this._input.click(); });
    ...
    openFilePicker() { if (this.hasAttribute('locked')) return; this._exitReframe(true); this._input.click(); }
    ...
    _render() {
      ...
      const editable = !this._locked && !!(window.omelette && window.omelette.writeFile);
